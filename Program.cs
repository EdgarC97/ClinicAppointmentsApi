...
builder.Services.AddScoped<IDoctorAvailabilityService, DoctorAvailabilityService>(); // Doctor Availability service 
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Clinic Appointment Management API ", Version = "v1" }); // Configure Swagger documentation
